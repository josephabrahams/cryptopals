...
from cryptopals.repeatingkey_xor import repeatingkey_xor
from cryptopals.utils import ascii_to_hex
...
if __name__ == '__main__':
    ...
    print(ascii_to_hex(repeatingkey_xor(args.message, args.key)))
